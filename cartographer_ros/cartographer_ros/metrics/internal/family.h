...
#ifndef CARTOGRAPHER_ROS_METRICS_FAMILY_H
#define CARTOGRAPHER_ROS_METRICS_FAMILY_H
...
class CounterFamily
 ...
 public:
  ...
  cartographer_ros_msgs::CounterFamily ToRosMessage();
...
class GaugeFamily
 ...
 public:
  ...
  cartographer_ros_msgs::GaugeFamily ToRosMessage();
...
class HistogramFamily : public ::cartographer::metrics::Family<
 ...
 public:
  ...
  cartographer_ros_msgs::HistogramFamily ToRosMessage();
...
#endif  // CARTOGRAPHER_ROS_METRICS_FAMILY_H